	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">子分类添加</div>
				<div class="panel-body">
					<div class="col-md-10 col-md-offset-2">
						<form role="form" action="/work/inte_shop/index.php/Admin/Cate/insert" method="post">
							<div class="form-group">
								<label>子分类名称</label>
								<input class="form-control" placeholder="请输入分类名称" type="text" name="name">
							</div>

							<div class="form-group">
								<label>父级分类</label>
								<select class="form-control" name="pid">
									<?php if(is_array($res)): foreach($res as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" selected><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
								</select>
							</div>
