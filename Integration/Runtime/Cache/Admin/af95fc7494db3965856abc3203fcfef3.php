			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="col-md-10 col-md-offset-2">
						<form role="form" action="/work/inte_shop/index.php/Admin/Cate/update" method="post">
							<div class="form-group">
								<label>父级分类</label>
								<input disabled class="form-control" value="<?php echo (getpname($vo['pid'])); ?>" type="text" name="username">
							</div>

							<div class="form-group">
								<label>原分类名称</label>
								<input disabled class="form-control" value="<?php echo ($vo['name']); ?>">
							</div>

							<div class="form-group">
								<label>新分类名称</label>
								<input class="form-control" placeholder="请输入新分类名称" type="text" name="name">
							</div>
