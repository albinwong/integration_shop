			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="col-md-10 col-md-offset-2">
						<form role="form" action="/work/inte_shop/index.php/Admin/Goods/insert" enctype="multipart/form-data" method="post">
							<div class="form-group">
								<label>商品分类</label>
							...
							<div class="form-group">
								<label>商品名称</label>
								<input class="form-control" placeholder="请输入商品名称" type="text" name="gname">
							</div>

							<div class="form-group">
								<label>商品编号</label>
								<input class="form-control" placeholder="请输入商品编号" type="text" name="gid">
							</div>

							<div class="form-group">
								<label>通宝价</label>
								<input class="form-control" placeholder="请输入通宝价" type="text" name="pv">
							</div>
							...
							<div class="form-group">
								<label>商品描述</label>
								<script id="editor1" name="desc" type="text/plain" style="width:700px;height:100px;"></script>
							</div>

							<div class="form-group">
								<label>商品特点</label>
								<script id="editor2" name="special" type="text/plain" style="width:700px;height:100px;"></script>
							</div>

							<div class="form-group">
								<label>注意事项</label>
								<script id="editor3" name="notice" type="text/plain" style="width:700px;height:100px;"></script>
							</div>
							...
							<div class="form-group">
								...
								<div class="radio">
									<label>
										<input name="status" id="optionsRadios1" value="1" checked type="radio">上架
									</label>
								</div>
								<div class="radio">
									<label>
										<input name="status" id="optionsRadios2" value="2" type="radio">下架
									</label>
								</div>
							</div>
							...
							<div class="form-group">
								<label>库存</label>
								<input class="form-control" placeholder="请输入商品库存" type="number" name="repertory">
							</div>

							<div class="form-group">
								<label>库存</label>
								<input class="form-control" placeholder="请输入商品销量" type="number" name="sales">
							</div>
