		...
		<ul class="nav menu">
			...
			<li class="parent ">
				...
				<ul class="children collapse" id="sub-item-2">
					...
					<li>
						<a class="" href="<?php echo U('Admin/Cate/add');?>">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="col-md-10 col-md-offset-2">
						<form role="form" action="/work/inte_shop/index.php/Admin/User/update" method="post">
							<div class="form-group">
								<label>用户名</label>
								<input class="form-control" value="<?php echo ($vo["username"]); ?>" type="text" name="username">
							</div>

							<div class="form-group">
								<label>邮箱</label>
								<input class="form-control" value="<?php echo ($vo["email"]); ?>"  type="email" name="email">
							</div>

							<div class="form-group">
								<label>手机号码</label>
								<input class="form-control" value="<?php echo ($vo["phone"]); ?>"  type="text" name="phone">
							</div>
